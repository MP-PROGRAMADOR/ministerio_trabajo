...
try {
    ...
    sede_formacion,
    profesion_oficio,
    fecha_desempleo, -- <-- TRAE LA FECHA ORIGINAL AQUÍ (Formato YYYY-MM-DD)
...
<div class="d-flex" id="wrapper">
    ...
    <div class="container-fluid p-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="estado" class="form-select form-select-sm">
                                ...
                                <option value="PENDIENTE"
                                    <?php echo $filtro_estado === 'PENDIENTE' ? 'selected' : ''; ?>>
                                    Pendiente</option>
                                <option value="SELECCIONADO"
                                    <?php echo $filtro_estado === 'SELECCIONADO' ? 'selected' : ''; ?>>Seleccionado
                                </option>
                                <option value="LISTA_ESPERA"
                                    <?php echo $filtro_estado === 'LISTA_ESPERA' ? 'selected' : ''; ?>>Lista de Espera
                                </option>
                                <option value="NO_SELECCIONADO"
                                    <?php echo $filtro_estado === 'NO_SELECCIONADO' ? 'selected' : ''; ?>>No
                                    Seleccionado</option>
                            </select>
                        </div>
        ...
        <div class="mensaje-alerta-container mb-3">
            ...
            <div class="alert alert-success alert-dismissible fade show shadow-sm d-flex align-items-center"
                role="alert" id="alerta-autoclose">
    ...
    data-fecha="<?php echo $per['fecha_desempleo'] ?? ''; ?>" data-bs-toggle="modal" 
    data-bs-target="#modalEditarCandidato"
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="apellido" class="form-control" placeholder="Ej: Mete Bijeri"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Número de Teléfono *</label>
                            <input type="tel" name="telefono" class="form-control" placeholder="Ej: +240 222 123 456"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Correo Electrónico <span
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="dip_numero" class="form-control font-monospace"
                                placeholder="Ej: 0948372-EG" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-text text-muted" style="font-size: 0.75rem;">Debe estar en formato PDF.
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="profesion_oficio" class="form-control"
                                placeholder="Ej: Electricista, Oficinista, etc.">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-8">
                            <label class="form-label fw-semibold">Foto Tamaño Carnet <span
                                    class="text-muted fw-normal">(Opcional)</span></label>
                            <input type="file" name="foto_carnet" id="inputFotoCarnet" class="form-control"
                                accept="image/*" onchange="previsualizarFoto(event)">
                            <div class="form-text text-muted" style="font-size: 0.75rem;">Formatos válidos: JPG, PNG,
                                JPEG.</div>
                        </div>
                        <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                            <label class="form-label fw-semibold mb-1 small text-secondary">Vista Previa</label>
                            <div id="contenedorPreview"
                                class="bg-light border d-flex align-items-center justify-content-center rounded text-muted"
                                style="width: 80px; height: 100px; overflow: hidden; position: relative;">
                                <i id="iconoPreview" class="bi bi-person fs-1"></i>
                                <img id="imagenPreview" src="" alt="Vista previa" class="d-none w-100 h-100"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title fw-bold">
                    <i class="bi bi-pencil-square me-2"></i>Editar Candidato / Cambiar Estado
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <form action="../php/actualizar_desempleado.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label class="form-label fw-semibold text-primary">Estado del Proceso *</label>
                            <select name="estado_seleccion" id="edit_estado" class="form-select border-primary"
                                required>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Número de DIP *</label>
                            <input type="text" name="dip_numero" id="edit_dip" class="form-control font-monospace"
                                required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Actualizar DIP (Solo si desea cambiar el PDF
                                actual)</label>
                            <input type="file" name="dip_copia_pdf" class="form-control" accept=".pdf">
                            <div class="form-text text-muted" style="font-size: 0.75rem;">Dejar en blanco para conservar
                                el actual.</div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="provincia" id="edit_provincia" class="form-select" required
                                onchange="cargarDistritosEdicion()">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Distrito *</label>
                            <select name="distrito" id="edit_distrito" class="form-select" required>
                                <option value="" disabled>-- Seleccione Distrito --</option>
                            </select>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Sede de Formación *</label>
                            <select name="sede_formacion" id="edit_sede" class="form-select" required>
                                <option value="BATA">Bata</option>
                                <option value="MALABO">Malabo</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Última Profesión u Oficio</label>
                            <input type="text" name="profesion_oficio" id="edit_profesion" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Fecha desde que está Desempleado</label>
                            <input type="date" name="fecha_desempleo" id="edit_fecha_desempleo" class="form-control">
                        </div>

                        <div class="col-md-8">
                            <label class="form-label fw-semibold">Actualizar Foto Carnet <span
                                    class="text-muted fw-normal">(Opcional)</span></label>
                            <input type="file" name="foto_carnet" id="edit_inputFoto" class="form-control"
                                accept="image/*" onchange="previsualizarFotoEdicion(event)">
                            <div class="form-text text-muted" style="font-size: 0.75rem;">Dejar en blanco para mantener
                                la foto actual.</div>
                        </div>
                        <div class="col-md-4 d-flex flex-column align-items-center justify-content-center">
                            <label class="form-label fw-semibold mb-1 small text-secondary">Vista Previa Nueva</label>
                            <div id="edit_contenedorPreview"
                                class="bg-light border d-flex align-items-center justify-content-center rounded text-muted"
                                style="width: 80px; height: 100px; overflow: hidden; position: relative;">
                                <i id="edit_iconoPreview" class="bi bi-person fs-1"></i>
                                <img id="edit_imagenPreview" src="" alt="Vista previa" class="d-none w-100 h-100"
                                    style="object-fit: cover;">
                            </div>
                        </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Delegación de eventos en el document para capturar clicks en botones que se carguen dinámicamente
    document.addEventListener("click", function(event) {
        // Buscamos si el clic ocurrió en el botón de editar o dentro de él (por el icono)
        const btn = event.target.closest(".btn-editar-candidato");
        
        if (btn) {
            // Capturar los valores data-* del botón de manera segura
            const id = btn.getAttribute("data-id") || "";
            const nombre = btn.getAttribute("data-nombre") || "";
            const apellido = btn.getAttribute("data-apellido") || "";
            const telefono = btn.getAttribute("data-telefono") || "";
            const email = btn.getAttribute("data-email") || "";
            const dip = btn.getAttribute("data-dip") || "";
            ...
            const profesion = btn.getAttribute("data-profesion") || "";
            const estado = btn.getAttribute("data-estado") || "";
            const fecha = btn.getAttribute("data-fecha") || ""; // Asegúrate de agregar data-fecha al HTML
            

            // Rellenar los campos del Modal (Verificando que existan en el DOM para evitar errores)
            ...
            if(document.getElementById("edit_apellido")) document.getElementById("edit_apellido").value = apellido;
            ...
            if(document.getElementById("edit_dip")) document.getElementById("edit_dip").value = dip;
            if(document.getElementById("edit_provincia")) document.getElementById("edit_provincia").value = provincia;
            
            // Convertir de forma segura a mayúsculas
            if(document.getElementById("edit_sede")) {
                document.getElementById("edit_sede").value = sede ? sede.toUpperCase() : "";
            }
            
            if(document.getElementById("edit_profesion")) document.getElementById("edit_profesion").value = profesion;
            if(document.getElementById("edit_estado")) document.getElementById("edit_estado").value = estado;
            if(document.getElementById("edit_fecha_desempleo")) document.getElementById("edit_fecha_desempleo").value = fecha;

            // Limpiar preview de foto en cada apertura de forma segura
            const previewImg = document.getElementById("edit_imagenPreview");
            const previewIcon = document.getElementById("edit_iconoPreview");
            const inputFoto = document.getElementById("edit_inputFoto");
            ...
            // Forzar la recarga dinámica de distritos según la provincia seteada
            cargarDistritosEdicion(distrito);
        }
    });
});

// Función de mapeo dinámico de Distritos en el Modal de Edición (Corregida)
function cargarDistritosEdicion(distritoSeleccionado = "") {
    const selectProvincia = document.getElementById("edit_provincia");
    const selectDistrito = document.getElementById("edit_distrito");
    
    if (!selectProvincia || !selectDistrito) return;
    ...
    const distritosPorProvincia = {
        ...
        "Bioko Sur": ["Luba", "Riaba"],
        "Litoral": ["Bata", "Mbini", "Cogo"],
        "Centro Sur": ["Evinayong", "Niefang", "Acurenam"],
        "Kié-Ntem": ["Ebebiyín", "Micomeseng", "Nsok-Nsomo"],
        "Wele-Nzas": ["Mongomo", "Añisok", "Nsork"],
        "Annobón": ["San Antonio de Palea"],
        "Djibloho": ["Oyala"]
    };

    // Vaciar distritos anteriores
    selectDistrito.innerHTML = '<option value="" disabled>-- Seleccione Distrito --</option>';

    if (provincia && distritosPorProvincia[provincia]) {
        distritosPorProvincia[provincia].forEach(dist => {
            const option = document.createElement("option");
            option.value = dist;
            option.textContent = dist;
            if (dist === distritoSeleccionado) {
...
// Vista previa de imagen en la edición
function previsualizarFotoEdicion(event) {
    const input = event.target;
    const reader = new FileReader();
    reader.onload = function() {
        const img = document.getElementById('edit_imagenPreview');
        const icon = document.getElementById('edit_iconoPreview');
        if (img && icon) {
