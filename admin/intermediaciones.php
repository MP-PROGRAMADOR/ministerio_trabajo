...
<div class="d-flex" id="wrapper">
    ...
    <div class="d-flex justify-content-end mb-3">
        <button class="btn btn-primary d-flex align-items-center gap-2 shadow-sm" data-bs-toggle="modal" data-bs-target="#modalAñadir">
            ...
            <table id="tablaNotificaciones" class="table table-hover align-middle mb-0 w-100">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>11 Jul, 2026</td>
                        <td class="text-end">
                            <button class="btn btn-sm btn-success rounded-circle" title="Aprobar" data-bs-toggle="tooltip">
                                <i class="bi bi-check-lg"></i>
                            </button>
                            <button class="btn btn-sm btn-outline-danger rounded-circle" title="Rechazar" data-bs-toggle="tooltip">
                                <i class="bi bi-x-lg"></i>
                            </button>
                            <button class="btn btn-sm btn-light rounded-circle" title="Ver Detalles" data-bs-toggle="modal" data-bs-target="#modalDetalleNotificacion">
                                <i class="bi bi-eye"></i>
                            </button>
                        </td>
                    </tr>
