<?php
// ============================================================
// HEADER PARA ADMINISTRADORES - CORREGIDO
// ============================================================
...
try {
    // ===== 1. ESTADÍSTICAS =====
    $stmt = $pdo->query("SELECT COUNT(*) FROM buscadores_empleo");
    ...
    // ===== 2. NOTIFICACIONES (SIN LA COLUMNA 'origen') =====
    $sql_notificaciones = "
        SELECT 
            ni.id,
    ...
    // En lugar de morir, mostrar mensaje de error pero continuar
...
<head>
    ...
    <title>Sistema de Intermediación - Oficina Central de Eepleo (GE)</title>
