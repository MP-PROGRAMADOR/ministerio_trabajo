...
CREATE TABLE personas_desempleadas (
    ...
    dip_numero VARCHAR(30) UNIQUE NOT NULL COMMENT 'Número de DIP escrito (único por persona)',
    dip_copia_pdf VARCHAR(255) NOT NULL COMMENT 'Ruta del documento DIP escaneado estrictamente en formato PDF',
