...
<head>
    ...
    <title>Cursos Públicos - Portal de Empleo</title>
    ...
    <style>
        ...
        .list-item-custom .accent-bar.blue {
            background: var(--gov-blue);
        }
        .list-item-custom .accent-bar.gold {
            background: var(--gov-gold);
        }
        .list-item-custom .accent-bar.green {
...
<body>
    ...
    <div class="main-wrapper">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto align-items-lg-center ms-lg-4 gap-2">
                        ...
                        <li class="nav-item"><a class="nav-link" href="bolsa_trabajo.php">Bolsa de Trabajo</a></li>
                        <li class="nav-item"><a class="nav-link active fw-bold text-primary" href="cursos_publicos.php">Cursos Públicos</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <main class="container py-5 flex-grow-1">
            ...
            <div class="row g-4">
                <!-- FILTROS (sin botón buscar, solo limpiar) -->
                <div class="col-12">
    ...
    <script>
        ...
        // Búsqueda en tiempo real: input y cambios en selects
